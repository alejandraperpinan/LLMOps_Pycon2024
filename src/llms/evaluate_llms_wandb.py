...
config = {
  ...
  "prompt_version":'aleja-unal/LLMOps-Pycon2024/prompt_template:v1'
}
...
with wandb.init(project="LLMOps-Pycon2024",name=f"Evaluate-RAG ExecId-{args.IdExecution}", job_type="evaluate-rag") as run:
  ...
  artifact = run.use_artifact('aleja-unal/LLMOps-Pycon2024/prompt_template:v0', type='dataset')
  artifact_dir = artifact.download()
...
with wandb.init(project="LLMOps-Pycon2024",name=f"Evaluate-RAG ExecId-{args.IdExecution}", job_type="evaluate-rag") as run:
  ...
  artifact = run.use_artifact('aleja-unal/LLMOps-Pycon2024/prompt_template:v1', type='dataset')
  artifact_dir = artifact.download()
